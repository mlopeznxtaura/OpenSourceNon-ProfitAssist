...
class WorldEngineGUI:
    """Graphical User Interface for World Engine.
    ...
    def launch(self) -> None:
        ...
        self._root = tk.Tk()
        self._root.title("World Engine Control Panel")
    ...
    def _setup_ui(self) -> None:
        ...
        title_label = ttk.Label(
            main_frame, 
            text="World Engine Control Panel",
