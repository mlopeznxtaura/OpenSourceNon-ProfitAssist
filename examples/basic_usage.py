"""Example usage of Modular Cognitive Engine."""

from cognitive_engine import Engine, ModuleBase, Layer
from cognitive_engine.layers import CognitiveLayer, MobileLayer, HostLayer


def basic_example():
    """Basic example of using Modular Cognitive Engine."""
    print("=== Basic Example ===\n")
